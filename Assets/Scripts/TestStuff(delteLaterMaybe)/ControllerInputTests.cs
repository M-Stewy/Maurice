...
public class ControllerInputTests : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            Debug.Log("Joystick 0"); // is square on PS controller
        }
        if (Input.GetKeyDown(KeyCode.Joystick1Button1))
        {
            Debug.Log("Joystick 1"); // is X on PS controller
        }
        if (Input.GetKeyDown(KeyCode.Joystick1Button2))
        {
            Debug.Log("Joystick 2"); // is circle on PS controller
        }
        if (Input.GetKeyDown(KeyCode.Joystick1Button3))
        {
            Debug.Log("Joystick 3"); // is triganle on PS controller
        }
        if (Input.GetKeyDown(KeyCode.Joystick1Button4))
        {
            Debug.Log("Joystick 4"); // is left trigger on PS controller
        }
        if (Input.GetKeyDown(KeyCode.Joystick1Button5))
        {
            Debug.Log("Joystick 5"); // is right trigger on PS controller
        }
        if (Input.GetKeyDown(KeyCode.Joystick1Button6))
        {
            Debug.Log("Joystick 6"); // is left bumper on PS controller
        }
        if (Input.GetKeyDown(KeyCode.Joystick1Button7))
        {
            Debug.Log("Joystick 7"); // is right bumper on PS controller
        }
        if (Input.GetKeyDown(KeyCode.Joystick1Button8))
        {
            Debug.Log("Joystick 8"); // is "share" button on PS controller
        }
        if (Input.GetKeyDown(KeyCode.Joystick1Button9))
        {
            Debug.Log("Joystick 9"); // is "options" button on PS controller
        }
